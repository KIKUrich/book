...
<%@ page
	import="com.book.bean.AdminBean,com.book.bean.HistoryBean,com.book.dao.BookDao,com.book.dao.AdminDao"%>
							...
							<div
								...
								<form class="form-horizontal" action="/books/AddProblemServlet"
									...
									<div class="col-lg-8 form-group">
										<%--@declare id="query_bname"--%><label class="col-lg-4" for="query_bname">标题</label>
										<div class="col-lg-12">
