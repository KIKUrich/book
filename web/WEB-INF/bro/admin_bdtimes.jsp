...
<%@ page
	import="com.book.bean.AdminBean,com.book.dao.AdminDao,com.book.bean.BookBean,com.book.dao.BookDao"%>
							...
							<div
								...
								<form class="form-horizontal" action="/books/bdtimesServlet"
									...
									<div class="col-lg-8 form-group">
										<%--@declare id="query_bname"--%><label class="col-lg-4 control-label" for="query_bname">图书信息</label>
										<div class="col-lg-8">
