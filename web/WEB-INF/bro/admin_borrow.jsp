...
<%@ page
	import="com.book.bean.HistoryBean,com.book.dao.AdminDao,com.book.dao.TypeDao,com.book.dao.BookDao,com.book.bean.AdminBean"%>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<div class="form-group">
							<%--@declare id="endtime"--%><label for="endtime" class="col-sm-3 control-label">截至还书时间</label>
							<div class="col-sm-7">
								<%--@declare id="updatetime"--%><input type="hidden" id="updatehid" name="hid">
