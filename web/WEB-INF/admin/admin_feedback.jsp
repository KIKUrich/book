...
<%@ page
	import="com.book.bean.AdminBean,com.book.dao.AdminDao,com.book.bean.ProblemBean,com.book.dao.ProblemDao"%>
							...
							<div
								...
								<form class="form-horizontal" action="/books/selectProblemServlet"
									...
									<div class="col-lg-8 form-group">
										<%--@declare id="query_bname"--%><label class="col-lg-4 control-label" for="query_bname">反馈信息</label>
										<div class="col-lg-8">
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<div class="form-group">
							<%--@declare id="firstname"--%><label for="firstname" class="col-sm-3 control-label">状态</label>
							<div class="col-sm-7">
								<%--@declare id="updateisbn"--%><input type="hidden" name="pid" id="updatepid"> <input
