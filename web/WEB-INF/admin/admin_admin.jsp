...
<%@ page
	import="com.book.bean.AdminBean,com.book.dao.AdminDao,com.book.bean.AdminBean"%>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<%--@declare id="updateisbn"--%><input type="hidden" id="updateaid" name="aid"> <input
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<%--@declare id="updatebookname"--%><input type="text" class="form-control" id="updatename"
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<%--@declare id="updateauthor"--%><input type="text" class="form-control" id="updateemail"
									name="email" placeholder=""> <label
									class="control-label" for="updateAuthor" style="display: none;"></label>
							</div>
						</div>
						<div class="form-group">
							<label for="firstname" class="col-sm-3 control-label">手机号</label>
							<div class="col-sm-7">
								<%--@declare id="updatepress"--%><input type="text" class="form-control" id="updatephone"
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<input type="text" class="form-control" name="email"
									id="addAuthor" required="required" placeholder="请输入邮箱">
								<label class="control-label" for="addAuthor"
									style="display: none;"></label>
							</div>
						</div>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<div class="form-group">
							<%--@declare id="firstname"--%><label for="firstname" class="col-sm-3 control-label">邮箱</label>
							<div class="col-sm-7">
